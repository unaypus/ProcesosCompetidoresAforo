 ...
 * 
 */
public class CFicherosDirectos {
    ...
    private RandomAccessFile flujoEscritura;
     ...
     * 
     */
    public CFicherosDirectos(   String cNombre, 
                                String cArchivo, 
                                int iCampos, 
                                String losCampos[], 
                                int tamRegistro,
     ...
     * @return 
     */
    public boolean guardarRegistro( int nCampoCOD,
                                    String sCampoCCC,
                                    String sCampoENT,
                                    String sCampoOF,
                                    String sCampoDC,
        ...
        try{
            // CCC
            // CÓDIGO
            flujoEscritura.writeInt(nCampoCOD);
            // CUENTA
            flujoEscritura.writeUTF(sCampoCCC); 
            // ENTIDAD
            flujoEscritura.writeUTF(sCampoENT); 
            // OFICINA
            flujoEscritura.writeUTF(sCampoOF); 
            // DC
            flujoEscritura.writeUTF(sCampoDC); 
            // TITULAR
            flujoEscritura.writeUTF(sCampoTIT); 
            // SALDO
            flujoEscritura.writeDouble(nCampoSALD);
    ...
    public boolean crearArchivo(){
        ...
        // Crea un fichero vacio con los cóodigos con valor cero
        ...
        try{
            ...
            flujoEscritura =new RandomAccessFile(ficheroDIR,"rw");
            
            for(int i=0;i<nMaxREG;i++) {
                // Este es para CestrorCuentaBancaria.java
                //  10,4,4,2,40,int
                guardarRegistro(    0,
                                    "1234567891",
                                    "1234",
                                    ...
                                    0);
                /*
                // Este es para GestorPeliculas.java
                guardarRegistro( 0,"12345678911234567892",0,0);
                */
            }
            nRegLibres = nMaxREG;
    ...
    public boolean modifRgistro(String aCampos[], int posREG){
        ...
        try {            
            ...
            flujoEscritura.seek((posREG-1)*tamRegistro);
            
            if(flujoEscritura.readInt()==posREG){
                
                flujoEscritura.seek((posREG-1)*tamRegistro);
                if(guardarRegistro( posREG,
                                    aCampos[1],
                                    aCampos[2],
                                    aCampos[3],
                                    aCampos[4],
    ...
    public boolean altaRegistro(String aCampos[]){
        ...
        try {            
            ...
            for(int nContador = 0 ; nContador < nMaxREG; nContador++){
                ...
                flujoEscritura.seek(nContador*tamRegistro);
                
                if(flujoEscritura.readInt()==0){
                    
                    // añadimos el nuevo registro");
                    flujoEscritura.seek(nContador*tamRegistro);
                    
                    if(guardarRegistro( nContador+1,
                                        aCampos[1],
                                        aCampos[2],
                                        aCampos[3],
                                        aCampos[4],
    ...
    public boolean bajaRegistro(String cadBusca){
        ...
        try {
            ...
            flujoEscritura.seek((nCodBusqueda-1)*tamRegistro);
            
            codigo=flujoEscritura.readInt();
