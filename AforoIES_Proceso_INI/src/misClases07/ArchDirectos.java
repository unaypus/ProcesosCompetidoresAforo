...
public class ArchDirectos {
     ...
     * 
     */
    public ArchDirectos(    String cNombre, 
                            String cArchivo, 
                            int iCampos, 
                            String losCampos[], 
                            int tamRegistro,
    ...
    public boolean bloqueado(){
        ...
        try{
            ...
            bloqueo         = fEscrituraLectura.getChannel().lock();
            return true;
    ...
    public boolean guardarRegistro( int[] campoINT){
                      
        try{
            
            //Crea un flujo de E/S para un fichero de acceso directo, en modo rw para grabar
            //flujoEscritura  = new RandomAccessFile(ficheroDIR,"rw");
            //bloqueo         = flujoEscritura.getChannel().lock();
            fEscrituraLectura.seek(0);
            fEscrituraLectura.writeInt( campoINT[ 0 ] ) ; 
            fEscrituraLectura.writeInt( campoINT[ 1 ] ) ;
            fEscrituraLectura.writeInt( campoINT[ 2 ] ) ;
            fEscrituraLectura.writeInt( campoINT[ 3 ] ) ;
        ...
        /*}finally{
            ...
            try{
                ...
                if( null != flujoEscritura ) flujoEscritura.close();
    ...
    public boolean crearArchivo(){
        ...
        try{
            ...
            if( bloqueado() ){
                if( guardarRegistro( Constantes.REGISTRO_INI ) ){ 
                    if( desbloqueado() ){ nError = 0 ; }
                }
    ...
    public boolean escribirCampo( int queCampo, int campINT ){
